...
#     parser.add_argument('--pretrain_path', type=str, default='/nfs/masi/gaor2/saved_file/MissClinic/MNIST2Fashion/cls/fashion_128dim/models/model_epoch_0134.pth') # 49 for mnist, 134 for fashion
    ...
    parser.add_argument('--m-block-len', type=int, default=0)
    parser.add_argument('--f-block-len', type=int, default=27)
    parser.add_argument('--block-len-max', type=int, default=28)
    # option for indep:
    ...
    parser.add_argument('--save_foldname', default='20210215_singlem')
